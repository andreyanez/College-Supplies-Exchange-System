			...
			<div class="b1-ctn">
				<div class="b1-top">
					...
					<div class="b1-details">
						...
						<div class="b1-alquiler">
							...
							<div class="b1-info condicion" v-if="!!material.condition">
								<h3>Estado</h3>
								<h4 v-if="material.condition.id == 1" class="optimo">Óptimo</h4>
								<h4 v-if="material.condition.id == 2" class="gastado">Usado</h4>
								<h4 v-if="material.condition.id == 3" class="depreciar">
									Por Depreciar
								</h4>
							</div>
						</div>
						<div class="b1-lugar" v-if="!!material.materialxplace">
							<ul>
								<li
				...
				<div class="b1-bottom">
					...
					<div class="b1-owner">
						...
						<div class="b1-block">
							<div class="b1-num" v-if="!!material.user">
